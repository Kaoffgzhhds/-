...
Tabs.Main:AddParagraph({
        Title = "⚡ Credit you Kao"
})
Tabs.Main:AddButton({
    Title = "YouTube : Kao",
    Description = "ช่องยูทูปคุณ Kao",
    Callback = function()
    game.StarterGui:SetCore("SendNotification", {
        Title = "คุณ : ฟ่างฮับ ✅",
        Text = "Press Follow Channel @kao คนหล่อ",
        Duration = 6
    })
        setclipboard("https://www.youtube.com/@Kao-g9")
    end
})
Tabs.Main:AddButton({
    Title = "Discord : Kao",
    ...
    Callback = function()
    game.StarterGui:SetCore("SendNotification", {
        Title = "คุณ : Millet Hub ✅",
        Text = "Discord : Kao ผู้เขียนโปร",
        Icon = "rbxassetid://18888999404",
        Duration = 6
    })
        setclipboard("https://discord.gg/KbrzX3tpT5")
    end
})
